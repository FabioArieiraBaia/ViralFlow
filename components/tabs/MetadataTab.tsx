                        ...
                        <div className="space-y-6">
                            ...
                            {thumbnails.length > 0 && (
                                <div className="space-y-4">
                                    ...
                                    <button onClick={() => generateThumbnails(topic, style, thumbProvider).then(setThumbnails)} className="text-xs font-bold text-indigo-600 dark:text-indigo-400 hover:underline flex items-center gap-1"><RefreshCcw className="w-3 h-3"/> {t.regenerateThumbs}</button>
                                </div>
                            )}
                        </div>
                    ) : (
